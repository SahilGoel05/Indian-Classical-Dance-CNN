# -*- coding: utf-8 -*-
"""Indian Classical Dance CNN.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1IaiDTBogHp3isrQCVEJR69m_XE2cISSY
"""
...
import pandas as pd # data processing, CSV file I/O (e.g. pd.read_csv)es
...
for x in fil:
    ...
    final_train = os.path.join('/kaggle1/working/identify-dance-form/tests/unknown',x)
    copyfile(train_temp, final_train)
